...
if (exists("SYSTEM_COMMAND_ARGS")) {
  ...
  if (length(SYSTEM_COMMAND_ARGS) >= 7) SCENARIO_REFERENCE_NAME <- SYSTEM_COMMAND_ARGS[7] else SCENARIO_REFERENCE_NAME <- BASE_SCENARIO_BASE_NAME
  ...
  SCENARIO_REFERENCE_NAME <- BASE_SCENARIO_BASE_NAME

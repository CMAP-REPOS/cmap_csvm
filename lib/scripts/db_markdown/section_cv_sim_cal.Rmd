...
# Organize
dat <- cal_results$cv_sim_scheduledstops$submodel_extra$submodel_comparison_stop_dist[, .(Activity, Target = round(Target,2), Model = round(Model,2), Ratio = round(Ratio,2))]

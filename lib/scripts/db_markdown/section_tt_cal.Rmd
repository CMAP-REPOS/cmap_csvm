...
# Organize
dat_obs <- cal_results$calibration_targets_tt_sim$tt_build$countyod_all[, .(TargetTrips = sum(n)), keyby = .(OriginCounty = OCounty)]
...
# Organize
dat_obs <- cal_results$calibration_targets_tt_sim$tt_build$countyod_all[, .(TargetTrips = sum(n)), keyby = .(DestinationCounty = DCounty)]
dat_obs[, Target := TargetTrips/sum(TargetTrips)]
...
# Organize
dat_obs <- cal_results$calibration_targets_tt_sim$tt_build$countyod_light[, .(TargetTrips = sum(n)), keyby = .(OriginCounty = OCounty)]
dat_obs[, Target := TargetTrips/sum(TargetTrips)]
...
# Organize
dat_obs <- cal_results$calibration_targets_tt_sim$tt_build$countyod_medium[, .(TargetTrips = sum(n)), keyby = .(OriginCounty = OCounty)]
dat_obs[, Target := TargetTrips/sum(TargetTrips)]
...
# Organize
dat_obs <- cal_results$calibration_targets_tt_sim$tt_build$countyod_all[, .(TargetTrips = sum(n), Target = sum(Target)), keyby = .(OriginCounty = OCounty, DestinationCounty = DCounty)]

...
# Plot
bar_plotter(dat, xvar = "Distance", yvar = "PctTrips",  fill = "Source", position = "dodge", ylabel = "Percentage of Trips", png_name = "p_cv_sim_scheduledtrips_all.png", xrotate = TRUE)

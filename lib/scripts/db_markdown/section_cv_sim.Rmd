...
Firm synthesis output comparisons with input and control data, for the first four models in the component that simulate firm stop activity (before the set of models that simulate linking stops together into tours)
...
# Plot
bar_plotter(dat[Activity == "Goods"], xvar = "Industry", yvar = "PctFirms",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Percentage of Firms")
...
# Plot
bar_plotter(dat[Activity == "Service"], xvar = "Industry", yvar = "PctFirms",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Percentage of Firms")
...
# Plot
bar_plotter(dat[Activity == "GoodsAndService"], xvar = "Industry", yvar = "PctFirms",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Percentage of Firms")
...
# Plot
bar_plotter(dat[Activity == "Other"], xvar = "Industry", yvar = "PctFirms",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Percentage of Firms")
...
# Plot
bar_plotter(dat, xvar = "Industry", yvar = "Stops",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Number of Stops")
...
# Plot
bar_plotter(dat[Activity == "Goods"], xvar = "Industry", yvar = "Stops",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Number of Stops")
...
# Plot
bar_plotter(dat[Activity == "Service"], xvar = "Industry", yvar = "Stops",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Number of Stops")
...
# Plot
bar_plotter(dat, xvar = "Activity_Vehicle", yvar = "PctStops",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Percentage of Stops", xlabel = "Activity and Vehicle")
...
# Organize
dat <- cal_results$cv_sim_stopduration$submodel_comparison[, .(ModelStops = sum(ModelStops), TargetStops = sum(TargetStops)), keyby = .(choice, Activity)]
dat[, Model := ModelStops/sum(ModelStops), by = Activity]
dat[, Target := TargetStops/sum(TargetStops), by = Activity]

dat <- melt.data.table(dat[, .(choice, Activity, Model, Target)], id.vars = c("choice", "Activity"), variable.name = "Source", value.name = "PctStops")
...
# Plot
bar_plotter(dat[Activity == "Goods"], xvar = "choice", yvar = "PctStops",  fill = "Source", position = "dodge", ylabel = "Percentage of Stops", xlabel = "Stop Duration")
...
# Plot
bar_plotter(dat[Activity == "Service"], xvar = "choice", yvar = "PctStops",  fill = "Source", position = "dodge", ylabel = "Percentage of Stops", xlabel = "Stop Duration")
...
# Organize
dat <- cal_results$cv_sim_stopduration$submodel_comparison[, .(ModelStops = sum(ModelStops), TargetStops = sum(TargetStops)), keyby = .(choice, Vehicle)]
dat[, Model := ModelStops/sum(ModelStops), by = Vehicle]
dat[, Target := TargetStops/sum(TargetStops), by = Vehicle]

dat <- melt.data.table(dat[, .(choice, Vehicle, Model, Target)], id.vars = c("choice", "Vehicle"), variable.name = "Source", value.name = "PctStops")
...
# Plot
bar_plotter(dat[Vehicle == "Light"], xvar = "choice", yvar = "PctStops",  fill = "Source", position = "dodge", ylabel = "Percentage of Stops", xlabel = "Stop Duration")
...
# Plot
bar_plotter(dat[Vehicle == "Medium"], xvar = "choice", yvar = "PctStops",  fill = "Source", position = "dodge", ylabel = "Percentage of Stops", xlabel = "Stop Duration")
...
# Plot
bar_plotter(dat[Vehicle == "Heavy"], xvar = "choice", yvar = "PctStops",  fill = "Source", position = "dodge", ylabel = "Percentage of Stops", xlabel = "Stop Duration")

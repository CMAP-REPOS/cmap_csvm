...
# Organize
dat <- cv_trips[,.N, keyby = .(County = Region.Destination, Activity)]
...
# Organize
dat <- cv_trips[Vehicle == "Light",.N, keyby = .(County = Region.Destination, Activity)]
...
# Organize
dat <- cv_trips[Vehicle == "Medium",.N, keyby = .(County = Region.Destination, Activity)]
...
# Organize
dat <- cv_trips[Vehicle == "Heavy",.N, keyby = .(County = Region.Destination, Activity)]
...
# Organize
dat <- cv_trips[,.N, keyby = .(County = Region.Destination, Activity, Vehicle)]
...
### Total Trip Origins by County and TOD

```{r Table_County_TOD_AllVehicle}
# Organize
dat <- cv_trips[,.(Vehicle = "All Vehicles", .N), keyby = .(County = Region.Origin, TOD)]
dat[, TOD := factor(TOD, levels = names(BASE_TOD_RANGES))]
...
# Save
fwrite(dat, file = file.path(SCENARIO_OUTPUT_PATH, "Commercial_County_TOD_AllVehicles.csv"), row.names = FALSE)
assign("db_tab_cv_county_tod_allvehicles", dat, envir = db_inputs)
...
### Light Vehicle Trip Origins by County and TOD

```{r Table_County_TOD_LightVehicle}
# Organize
dat <- cv_trips[Vehicle == "Light",.(.N), keyby = .(County = Region.Origin, TOD, Vehicle)]
dat[, TOD := factor(TOD, levels = names(BASE_TOD_RANGES))]
...
# Save
fwrite(dat, file = file.path(SCENARIO_OUTPUT_PATH, "Commercial_County_TOD_Light.csv"), row.names = FALSE)
assign("db_tab_cv_county_tod_light", dat, envir = db_inputs)
...
### Medium Truck Trip Origins by County and TOD

```{r Table_County_TOD_MediumVehicle}
# Organize
dat <- cv_trips[Vehicle == "Medium",.(.N), keyby = .(County = Region.Origin, TOD, Vehicle)]
dat[, TOD := factor(TOD, levels = names(BASE_TOD_RANGES))]
...
# Save
fwrite(dat, file = file.path(SCENARIO_OUTPUT_PATH, "Commercial_County_TOD_Medium.csv"), row.names = FALSE)
assign("db_tab_cv_county_tod_medium", dat, envir = db_inputs)
...
### Heavy Truck Trip Origins by County and TOD

```{r Table_County_TOD_HeavyVehicle}
# Organize
dat <- cv_trips[Vehicle == "Heavy",.(.N), keyby = .(County = Region.Origin, TOD, Vehicle)]
dat[, TOD := factor(TOD, levels = names(BASE_TOD_RANGES))]
...
# Save
fwrite(dat, file = file.path(SCENARIO_OUTPUT_PATH, "Commercial_County_TOD_Heavy.csv"), row.names = FALSE)
assign("db_tab_cv_county_tod_heavy", dat, envir = db_inputs)

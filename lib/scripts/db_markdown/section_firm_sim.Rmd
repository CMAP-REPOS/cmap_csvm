...
# Plot
bar_plotter(dat, xvar = "Industry", yvar = "Employment",  fill = "Source", position = "dodge", coord_flip = TRUE)
...
# Plot
bar_plotter(dat, xvar = "County", yvar = "Employment", fill = "Source", position = "dodge", coord_flip = TRUE)
...
# Plot
bar_plotter(dat, xvar = "County", yvar = "Households", fill = "Source", position = "dodge", coord_flip = TRUE)

...
# Plot
bar_plotter(dat, xvar = "Region", yvar = "N", xlabel = "County or other Geography", ylabel = "Firms", 
             coord_flip = TRUE)
```
...
```{r}
value <- format(ScenarioFirms[TAZ_TYPE=="CMAP MPO Area", sum(Employees)], big.mark = ",", trim = TRUE)
valueBox(value, caption = "Synthesized Employees<br>CMAP MPO Area</br>", icon = "fa-briefcase",
         color = rgb(rsgcolordf[1,], maxColorValue = 255))
```
...
# Plot
bar_plotter(dat, xvar = "Region", yvar = "Employees", xlabel = "County or other Geography", coord_flip = TRUE)
```

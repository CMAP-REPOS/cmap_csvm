...
# Plot
bar_plotter(dat[Activity == "Service"], xvar = "Industry", yvar = "Distance",  fill = "Source", position = "dodge", coord_flip = TRUE, ylabel = "Base to Stop Distance", png_name = "p_cv_sim_scheduledstops_base_stop_industry_service.png")

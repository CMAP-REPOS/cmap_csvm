...
# Plot
bar_plotter(dat[Vehicle == "Medium"], xvar = "TimePeriod", yvar = "PctTours",  fill = "Source", position = "dodge", ylabel = "Percentage of Tours", png_name = "p_cv_sim_scheduledtrips_heavy.png", xrotate = TRUE)

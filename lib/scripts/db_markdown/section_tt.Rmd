...
value <- format(sum(tmh_vtods[Source == "LD"]$Trips, na.rm = TRUE), digits = 0, big.mark = ",", scientific = FALSE, trim = TRUE)
...
value <- format(sum(tmh_vtods[Source == "CV"]$Trips, na.rm = TRUE), digits = 0, big.mark = ",", scientific = FALSE, trim = TRUE)
...
value <- format(sum(tmh_vtods[Source == "LD"]$VMT, na.rm = TRUE), digits = 0, big.mark = ",", scientific = FALSE, trim = TRUE)
...
value <- format(sum(tmh_vtods[Source == "CV"]$VMT, na.rm = TRUE), digits = 0, big.mark = ",", scientific = FALSE, trim = TRUE)

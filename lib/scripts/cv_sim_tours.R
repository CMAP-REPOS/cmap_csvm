...
cv_sim_tours <- function(firmStopsVehDur, firms, branch.limit, skims, model) {
  ...
  apollo_probabilities =
    function(
      ...
      V[['bbm']] = asc_bbm + asc_bbm_industry_leisure * industry_leisure + asc_bbm_industry_info_fire_prof * industry_info_fire_prof + asc_bbm_industry_medical_services * industry_medical_services + asc_bbm_industry_retail * industry_retail + asc_bbm_industry_industrial * industry_industrial + asc_bbm_industry_production * industry_production + asc_bbm_industry_ed_pub_other_ser * industry_ed_pub_other_ser + asc_bbm_industry_transportation * industry_transportation + asc_bbm_is_med_veh * is_med_veh + asc_bbm_is_hvy_veh * is_hvy_veh
      V[['bbs']] = asc_bbs + asc_bbs_industry_leisure * industry_leisure + asc_bbs_industry_info_fire_prof * industry_info_fire_prof + asc_bbs_industry_medical_services * industry_medical_services + asc_bbs_industry_retail * industry_retail + asc_bbs_industry_industrial * industry_industrial + asc_bbs_industry_production * industry_production + asc_bbs_industry_ed_pub_other_ser * industry_ed_pub_other_ser + asc_bbs_industry_transportation * industry_transportation + asc_bbs_is_med_veh * is_med_veh + asc_bbs_is_hvy_veh * is_hvy_veh
      V[['bnm']] = asc_bnm + asc_bnm_industry_leisure * industry_leisure + asc_bnm_industry_info_fire_prof * industry_info_fire_prof + asc_bnm_industry_medical_services * industry_medical_services + asc_bnm_industry_retail * industry_retail + asc_bnm_industry_industrial * industry_industrial + asc_bnm_industry_production * industry_production + asc_bnm_industry_ed_pub_other_ser * industry_ed_pub_other_ser + asc_bnm_industry_transportation * industry_transportation + asc_bnm_is_med_veh * is_med_veh + asc_bnm_is_hvy_veh * is_hvy_veh
      V[['bns']] = asc_bns + asc_bns_industry_leisure * industry_leisure + asc_bns_industry_info_fire_prof * industry_info_fire_prof + asc_bns_industry_medical_services * industry_medical_services + asc_bns_industry_retail * industry_retail + asc_bns_industry_industrial * industry_industrial + asc_bns_industry_production * industry_production + asc_bns_industry_ed_pub_other_ser * industry_ed_pub_other_ser + asc_bns_industry_transportation * industry_transportation + asc_bns_is_med_veh * is_med_veh + asc_bns_is_hvy_veh * is_hvy_veh
      V[['nbm']] = asc_nbm + asc_nbm_industry_leisure * industry_leisure + asc_nbm_industry_info_fire_prof * industry_info_fire_prof + asc_nbm_industry_medical_services * industry_medical_services + asc_nbm_industry_retail * industry_retail + asc_nbm_industry_industrial * industry_industrial + asc_nbm_industry_production * industry_production + asc_nbm_industry_ed_pub_other_ser * industry_ed_pub_other_ser + asc_nbm_industry_transportation * industry_transportation + asc_nbm_is_med_veh * is_med_veh + asc_nbm_is_hvy_veh * is_hvy_veh
      V[['nb0']] = asc_nb0 + asc_nb0_industry_leisure * industry_leisure + asc_nb0_industry_info_fire_prof * industry_info_fire_prof + asc_nb0_industry_medical_services * industry_medical_services + asc_nb0_industry_retail * industry_retail + asc_nb0_industry_industrial * industry_industrial + asc_nb0_industry_production * industry_production + asc_nb0_industry_ed_pub_other_ser * industry_ed_pub_other_ser + asc_nb0_industry_transportation * industry_transportation + asc_nb0_is_med_veh * is_med_veh + asc_nb0_is_hvy_veh * is_hvy_veh
      V[['nbs']] = asc_nbs + asc_nbs_industry_leisure * industry_leisure + asc_nbs_industry_info_fire_prof * industry_info_fire_prof + asc_nbs_industry_medical_services * industry_medical_services + asc_nbs_industry_retail * industry_retail + asc_nbs_industry_industrial * industry_industrial + asc_nbs_industry_production * industry_production + asc_nbs_industry_ed_pub_other_ser * industry_ed_pub_other_ser + asc_nbs_industry_transportation * industry_transportation + asc_nbs_is_med_veh * is_med_veh + asc_nbs_is_hvy_veh * is_hvy_veh
      V[['nnm']] = asc_nnm + asc_nnm_industry_leisure * industry_leisure + asc_nnm_industry_info_fire_prof * industry_info_fire_prof + asc_nnm_industry_medical_services * industry_medical_services + asc_nnm_industry_retail * industry_retail + asc_nnm_industry_industrial * industry_industrial + asc_nnm_industry_production * industry_production + asc_nnm_industry_ed_pub_other_ser * industry_ed_pub_other_ser + asc_nnm_industry_transportation * industry_transportation + asc_nnm_is_med_veh * is_med_veh + asc_nnm_is_hvy_veh * is_hvy_veh

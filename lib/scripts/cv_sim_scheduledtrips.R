...
cv_sim_scheduledtrips <- function(firmTourSequence, firms, skims_tod, model) {
  ...
  apollo_probabilities =
    function(
      ...
      V[['overnight']] = asc_overnight + CAL_ARRIVAL_1
      V[['a_0600']]    = asc_0600 + CAL_ARRIVAL_2 + asc_is_med_hvy_veh_0600 * is_med_hvy_veh + asc_is_no_stop_0600_0730 * is_no_stop 	   
      V[['a_0700']]    = asc_0700 + CAL_ARRIVAL_3 + asc_is_med_hvy_veh_0700 * is_med_hvy_veh + asc_is_no_stop_0600_0730 * is_no_stop 	   
      V[['a_0730']]    = asc_0730 + CAL_ARRIVAL_4 + asc_is_med_hvy_veh_0730 * is_med_hvy_veh + asc_is_no_stop_0600_0730 * is_no_stop 	   
      V[['a_0800']]    = asc_0800 + CAL_ARRIVAL_5 + asc_is_med_hvy_veh_0800 * is_med_hvy_veh  						   
      V[['a_0830']]    = asc_0830 + CAL_ARRIVAL_6 + asc_is_med_hvy_veh_0830 * is_med_hvy_veh  					 	   
      V[['a_0900']]    = asc_0900 + CAL_ARRIVAL_7 + asc_is_med_hvy_veh_0900 * is_med_hvy_veh  					 							+ asc_begin_not_base_0900_1630 * begin_not_base	   
      V[['a_0930']]    = asc_0930 + CAL_ARRIVAL_8 + asc_is_med_hvy_veh_0930 * is_med_hvy_veh  												+ asc_begin_not_base_0900_1630 * begin_not_base 	   
      V[['a_1000']]    = asc_1000 + CAL_ARRIVAL_9 + asc_is_med_hvy_veh_1000 * is_med_hvy_veh  					 							+ asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1030']]    = asc_1030 + CAL_ARRIVAL_10 + asc_is_med_hvy_veh_1030 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1100']]    = asc_1100 + CAL_ARRIVAL_11 + asc_is_med_hvy_veh_1100 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1130']]    = asc_1130 + CAL_ARRIVAL_12 + asc_is_med_hvy_veh_1130 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1200']]    = asc_1200 + CAL_ARRIVAL_13 + asc_is_med_hvy_veh_1200 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1230']]    = asc_1230 + CAL_ARRIVAL_14 + asc_is_med_hvy_veh_1230 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1300']]    = asc_1300 + CAL_ARRIVAL_15 + asc_is_med_hvy_veh_1300 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1330']]    = asc_1330 + CAL_ARRIVAL_16 + asc_is_med_hvy_veh_1330 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1400']]    = asc_1400 + CAL_ARRIVAL_17 + asc_is_med_hvy_veh_1400 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1430']]    = asc_1430 + CAL_ARRIVAL_18 + asc_is_med_hvy_veh_1430 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1500']]    = asc_1500 + CAL_ARRIVAL_19 + asc_is_med_hvy_veh_1500 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1530']]    = asc_1530 + CAL_ARRIVAL_20 + asc_is_med_hvy_veh_1530 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1600']]    = asc_1600 + CAL_ARRIVAL_21 + asc_is_med_hvy_veh_1600 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1630']]    = asc_1630 + CAL_ARRIVAL_22 + asc_is_med_hvy_veh_1630 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop + asc_begin_not_base_0900_1630 * begin_not_base  	   
      V[['a_1700']]    = asc_1700 + CAL_ARRIVAL_23 + asc_is_med_hvy_veh_1700 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop 						 	 + asc_end_not_base_1700_2100 * end_not_base 	   
      V[['a_1730']]    = asc_1730 + CAL_ARRIVAL_24 + asc_is_med_hvy_veh_1730 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop 							 + asc_end_not_base_1700_2100 * end_not_base 	   
      V[['a_1800']]    = asc_1800 + CAL_ARRIVAL_25 + asc_is_med_hvy_veh_1800 * is_med_hvy_veh + asc_single_stop_1030_1800 * is_single_stop 							 + asc_end_not_base_1700_2100 * end_not_base 	   
      V[['a_1900']]    = asc_1900 + CAL_ARRIVAL_26 + asc_is_med_hvy_veh_1900_2100 * is_med_hvy_veh												 + asc_end_not_base_1700_2100 * end_not_base 	   
      V[['a_2000']]    = asc_2000 + CAL_ARRIVAL_27 + asc_is_med_hvy_veh_1900_2100 * is_med_hvy_veh												 + asc_end_not_base_1700_2100 * end_not_base 	   
      V[['a_2100']]    = asc_2100 + CAL_ARRIVAL_28 + asc_is_med_hvy_veh_1900_2100 * is_med_hvy_veh												 + asc_end_not_base_1700_2100 * end_not_base 	   
